    ...
    <div className="flex flex-col w-[90%] mx-auto my-20 space-y-16">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="md:w-1/2 w-full text-left">
          <p className="font-newyork text-sm md:text-5xl font-light flex items-center border-b-2 border-[#3B799E] pb-2 w-fit">
            VISION–IET
          </p>
        </div>
        ...
        <div className="relative md:w-[1158px] w-full h-[231px] border-2 border-[#3B799E] overflow-hidden">
          ...
          />
          <div
            className="absolute inset-0 z-10 flex items-center justify-center px-20 text-white text-lg md:text-xl lg:text-2xl font-semibold leading-relaxed text-center"
            style={{
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="md:w-1/2 w-full text-right">
          <p className="font-newyork text-sm md:text-5xl font-light flex items-center justify-end border-b-2 border-[#3B799E] pb-2 w-fit ml-auto">
            VISION–DAVV
          </p>
        </div>
      </div>
