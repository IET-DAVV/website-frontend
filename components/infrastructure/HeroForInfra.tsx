...
Central hub for leadership, student services, and campus operations.
• Key Offices: Director’s Office, Exam Section, and Placement Cell.
• Facilities: Main Auditorium and IT Server Room.
• Functions: Core center for records, networking, and large-scale events.`,
    },
    {
      id: 2,
      name: "A Block",
  ...
  const getDisplayContent = () => {
    if (hoveredBlock !== null) {
      ...
      return {
        ...
        subheading: "",
        description: block?.description || "IET's overall academics part takes place in this 6 blocks.",
      };
    }
    return {
      heading: "Campus",
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8 sm:gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-6 sm:space-y-8 col-span-1 w-full">
            <AnimatePresence mode="wait">
              ...
              >
                <motion.h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-black mb-4 sm:mb-6 leading-tight font-newyork">
                  {displayContent.heading}
                </motion.h2>
                {displayContent.subheading && (
                  <motion.h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-black mb-6 sm:mb-8 leading-tight font-newyork">
                    {displayContent.subheading}
                  </motion.h2>
                )}
                <motion.p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed whitespace-pre-line">
          ...
          <div className="w-full col-span-1 lg:col-span-2">
            ...
            >
              {campusBlocks.map((block) => {
                const isActive = hoveredBlock === block.id;
                const isInactive = hoveredBlock !== null && !isActive;
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      ...
                      filter: isInactive ? "grayscale(100%)" : "grayscale(0%)",
                  ...
                  >
                    <div className="relative overflow-hidden rounded-lg shadow-lg group-hover:shadow-2xl transition-shadow duration-300">
                      ...
                      >
                        <motion.h3
                          className="text-white font-newyork font-semibold tracking-wide text-center px-2"
