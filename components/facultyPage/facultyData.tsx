...
const FacultyData = (): JSX.Element => {
  ...
  if (nameParam) {
    ...
    const faculty = facultyData.find(
      (data: FacultyMember) =>
        data.name.toLowerCase() === facultyName.toLowerCase()
    );
    ...
    return (
      <div className="max-w-7xl mx-auto bg-white p-6 mt-20 mb-20 relative flex gap-6">
        ...
        <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <p>
                  ...
                  {faculty.phone ? (
                    ...
                    >
                      +91 {faculty.phone.replace(/\s+/g, "").slice(0, 5)}{" "}
                      {faculty.phone.replace(/\s+/g, "").slice(5)}
                    </a>
                  ) : (
                    "N/A"
                  )}
                ...
                <p>
                  ...
                  {(faculty as any).qualification || null}
                </p>
              </div>
            </div>
            <div>
              ...
              <table className="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                  {faculty.qualifications.map((qual: string, index: number) => {
                    ...
                    const universityYearMatch =
                      universityYearPart.match(/^(.+?),\s*(\d{4})$/);
                    const university = universityYearMatch
                      ? universityYearMatch[1]
                      : universityYearPart;
                    const year = universityYearMatch
                      ? universityYearMatch[2]
                      : "";
                      ...
                      ?.content.map((item: any, index: number) => {
                        ...
                        return (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? item : item.designation || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.department || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.employerName || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.duration || "N/A"}
                            </td>
                          </tr>
                        );
                      })}
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
                    <tr className="bg-[#06779B] text-white">
                      ...
                      <th className="border border-gray-300 px-4 py-2 text-left">
                        Authors
                      </th><th className="border border-gray-300 px-4 py-2 text-left">
                        Publishers
                      </th>
                    </tr>
                  </thead>
                        ...
                        return (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="border border-gray-300 px-4 py-2">
                              {isString
                                ? "Journal/Conference"
                                : item.type || "Journal/Conference"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? item : item.title || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.year || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.paperLink || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.paperLink || "N/A"}
                            </td>
                      ...
                      ?.content.map((item: any, index: number) => {
                        ...
                        return (
                          <tr key={index} className="hover:bg-gray-50">
                            ...
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.studentName || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? item : item.thesisTitle || "N/A"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "Ongoing" : item.status || "Ongoing"}
                            </td>
                            <td className="border border-gray-300 px-4 py-2">
                              {isString ? "N/A" : item.year || "N/A"}
                            </td>
          ...
          {faculty.tabs?.find((tab) =>
            ...
            <div id="projects" className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2">
                {faculty.tabs
                  .find((tab) => tab.label.toLowerCase().includes("project"))
                  ?.content.map((item: any, index: number) => (
             ...
             {/* Workshop Tabel */}
          {faculty.tabs?.find((tab) =>
            tab.label.toLowerCase().includes("workshop")
          ) && (
            <div id="publications" className="mb-8">
              <h2 className="text-2xl font-bold text-[#06779B] mb-4 border-b-2 border-[#06779B] pb-2">
                Workshops and Conference Organized
              </h2>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
          ...
          {/* Other */}
          {faculty.tabs?.find((tab) =>
            tab.label.toLowerCase().includes("others")
          ) && (
            <div id="publications" className="mb-8">
              <h2 className="text-2xl font-bold text-[#06779B] mb-4 border-b-2 border-[#06779B] pb-2">
                Other Information
          ...
          {faculty.tabs
            ...
            .map((tab, index) => (
              <div
                key={index}
                id={index === 0 ? "other-details" : undefined}
                className="mb-8"
              >
                <h2 className="text-2xl font-bold text-[#06779B] mb-4 border-b-2 border-[#06779B] pb-2">
                  {tab.label}
