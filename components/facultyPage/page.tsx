...
const page: React.FC = () => {
  return (
    <>
      ...
      {/* Intro text */}
      <div className="ml-40 mr-40 p-4 text-lg font-medium text-[#434343]">
        IET-DAVV has{" "}
        <span className=" text-black font-bold">Eight major departments</span>{" "}
        with different engineering & Science streams. We have more than{" "}
        <span className="font-bold text-black ">85 faculty</span> members
        including (Regular, Visiting & Ad-hoc Faculty Members)
      </div>
